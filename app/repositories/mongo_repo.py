...
{
  "partida_id": 9000,          ← referência ao PostgreSQL
  "rodada": 1,
  "mandante":  { "nome": "...", "estatisticas": { ... } },
  "visitante": { "nome": "...", "estatisticas": { ... } }
}
"""
...
def get_estatisticas_partida(
    ...
    """Retorna o documento de estatísticas de uma partida, sem o _id."""
...
def get_estatisticas_multiplas(
    ...
    """Retorna documentos de múltiplas partidas de uma vez."""
    return list(
        collection.find(
...
def get_media_estatisticas_clube(
    ...
    """
    Retorna médias de estatísticas de um clube como mandante e visitante.
    Usa aggregation pipeline — eficiente mesmo com muitos documentos.
    """
...
def _montar_documento(partida_id: int, dados: EstatisticasPartidaCreate) -> dict:
    """Constrói o documento MongoDB a partir do schema de input."""
    return {
...
def create_estatisticas(
    ...
    (o índice único em partida_id também rejeitaria, mas a mensagem
    fica mais clara assim).
    """
...
def update_estatisticas(
    ...
    """
    Substitui completamente o documento de estatísticas (replace_one).
    Retorna None se não existir documento para o partida_id.
    """
